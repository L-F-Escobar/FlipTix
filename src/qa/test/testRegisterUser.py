...
class TestRegisterUser(unittest.TestCase):
    ...
    @unittest.skip("Phone parameter can be excluded from request")
    ...
    # Test a null Phone.
    @unittest.skip("Phone parameter can be a null value - (BUG)")
    ...
    # Test a int Phone.
    @unittest.skip("Phone parameter can be any integar value - (BUG)")
    ...
    # Test a float Phone.
    @unittest.skip("Phone parameter can be any float value - (BUG)")
    ...
    @unittest.skip("Phone parameter can be any string value - (BUG)")
    ...
    @unittest.skip("Phone parameter can be any array value - (BUG)")
    ...
    @unittest.skip("FirstName parameter can be any integar value")
    ...
    @unittest.skip("FirstName parameter can be any float value")
    ...
    @unittest.skip("FirstName parameter string value should always pass.")
    ...
    @unittest.skip("FirstName parameter can be any array value - (BUG)")
    ...
    # Test a int LastName.
    @unittest.skip("LastName parameter can be any integar value - (BUG)")
    ...
    @unittest.skip("LastName parameter can be any float value - (BUG)")
    ...
    @unittest.skip("LastName parameter string value should always be able to pass")
    ...
    @unittest.skip("LastName parameter can be any array value - (BUG)")
    ...
    # Test a int Password.
    @unittest.skip("Password parameter integar value should always pass.")
    ...
    @unittest.skip("Password parameter float value should always pass.")
    ...
    @unittest.skip("Password parameter string value should always pass.")
    ...
    @unittest.skip("Password parameter array value is passing - (BUG)")
